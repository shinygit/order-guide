...
const ListItems = ({ items, tableHeaderOffset }) => {
  ...
  const offsetFromTop = {
    top: `${tableHeaderOffset.offset}px`,
  }
  ...
  return (
    <div className='rounded border border-gray-700 bg-yellow-100 shadow-inner p-2'>
      <table className='table-auto m-auto text-lg xl:w-10/12'>
        <thead>
          <tr className='sdafasd'>
            <th className='hidden md:table-cell' style={offsetFromTop} />
            <th
              className='px-4 py-2 border border-gray-700 sticky top-0 bg-yellow-200'
              style={offsetFromTop}
            >
              Item
            </th>
            <th
              className='hidden md:table-cell px-4 py-2 border border-gray-700 sticky top-0 bg-yellow-200'
              style={offsetFromTop}
            >
              Size
            </th>
            <th
              className='hidden lg:table-cell px-4 py-2 border border-gray-700 sticky top-0 bg-yellow-200'
              style={offsetFromTop}
            >
              Product #
            </th>
