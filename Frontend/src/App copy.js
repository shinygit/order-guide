...
const App = () => {
  const [tableHeaderOffset, setTableHeaderOffset] = useState({
    offset: null,
  })
  ...
  return (
    <div className='flex-col p-3'>
      ...
      <FilterMenu
        ...
        setTableHeaderOffset={setTableHeaderOffset}
      />
      <SearchForm />
      ...
      >
        {loading ? (
          ...
          <ListItems items={items} tableHeaderOffset={tableHeaderOffset} />
        )}
      </LocSupContext.Provider>
    </div>
  )
